...
def MoG(x, params):
    ...
    logpdf = logsumexp_explicit(loglik_mix_T)
    return logpdf
...
def RNADE(x, params):
    ...
    for o_index, curr_order in enumerate(orderings):
        ...
        for i in curr_order:
            ...
            lpc = logsumexp_explicit(lp_components)  # Assumes N=1!
            lp_curr.append(lpc)
    ...
    logpdf = logsumexp_explicit(lp)  # Assumes N=1!
    return logpdf
