...
def logical_filter(l, logicals):
    ...
    """
    # Does itertools have a better way to do this??
...
def separate_discrete(X, column_names=None):
    ...
    """
    # TODO explain if robust against ints stored as fp
...
def separate_features(X, categorical, column_names=None):
    ...
    """
    # TODO i dont like how output struct changes
    # explain typical cases of how discrete and cat are different by examples
    if column_names:
